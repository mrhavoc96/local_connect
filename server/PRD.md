...
**Product Name:** Local Connect [Backend]
**Version:** 1.0.0  
**Product Type:** Backend API for Users and Sellers portal, local connect website
...
- **Project E-tailers:** Create and manage projects, assign roles, oversee all project activities
